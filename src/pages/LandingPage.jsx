        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Follow your favorite creators, discover new artists, and be part
              ...
              <div className="flex gap-6 min-w-max px-2 pt-2">
                {popularArtists.map((artist) => (
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-white group-hover:text-light-primary dark:group-hover:text-dark-highlight transition-colors truncate">
